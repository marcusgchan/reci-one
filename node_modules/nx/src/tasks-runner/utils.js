...
function getDependencyConfigs({ project, target }, defaultDependencyConfigs, projectGraph) {
    ...
    for (const dependencyConfig of dependencyConfigs) {
        const specifiers = typeof dependencyConfig.projects === 'string'
            ? [dependencyConfig.projects]
            : dependencyConfig.projects;
        for (const specifier of specifiers !== null && specifiers !== void 0 ? specifiers : []) {
            if (!(specifier in projectGraph.nodes) &&
