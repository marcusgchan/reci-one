...
function projectsToRun(nxArgs, projectGraph) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        let affectedGraph = nxArgs.all
            ? projectGraph
            : yield (0, affected_project_graph_1.filterAffected)(projectGraph, (0, file_utils_1.calculateFileChanges)((0, command_line_utils_1.parseFiles)(nxArgs).files, projectGraph.allWorkspaceFiles, nxArgs));
        if (nxArgs.exclude) {
